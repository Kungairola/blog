...
##okay so first important thing i leared was how to define a variable, make a method and function and how to use global() so that i can assign a function in the code and then call it
